package com.musamanru.goldenglove.team;
...
import com.musamanru.goldenglove.user.UserDAO;
...
//	팀원 등록 요청
	public void registerUser(TeamDTO dto) {
		...
		map.put("requester", "com/musamanru/goldenglove/team");
