			...
			<div class="loginContainer">
				...
				<form action="loginResult" method="post" id="loginForm" autocomplete="off">
					<table class="table">
						...
						<tr>
						<td>
							<input type="password" name="password" pattern="^(?=.*[a-z])(?=.*[0-9])(?=.*[!@#$%^&*_=+-]).{8,15}$" title="최소 8자리, 최대 15자리까지 입력가능합니다.(영어,특수문자,숫자 필수)" required placeholder="비밀번호">
						</td>
					</tr>
						<tr><td><button type="submit" class="login">로그인</button></td></tr>
						<tr><td><button onclick="location.href='kakaoLogin'" class="kakaoLogin"><img src="/images/kakao_login_large_narrow.png" alt="kakaoIcon"></button></td></tr>
						<tr><td><button onclick="location.href='naverLogin'" class="naverLogin"><img src="/images/btnG_naver.png" alt="naverIcon"></button></td></tr>
					</table>
				</form>
				<div class="findBox">
					<table class="table2">
