						...
						$(".registerSoldierBtn").on(
								...
								function() {
									...
									if ($(".dropdownBtn").text() == "") {
										...
										window.open('registerSoldier', '용병 등록',
		...
		<div class="soldier_boxes">
			...
			<div class="soldier_box">
				<button class="registerSoldierBtn">
					<img class="plusIcon" src="/images/plusIcon.png" /> 용병 등록
				</button>
				<button class="soldierLogBtn">
					<img class="baseballIcon" src="/images/baseball.png" /> 용병 로그
				</button>
			</div>
