		...
		<form autocomplete="off">
			<table>
				<tr>
					<td>팀 이름 </td>
					<td>
						<input type="text" name="teamName" id="teamName" value="${loginInfo.teamName }">
				...
				<tr>
					...
					<td>
						<span id="firstBase">${teamDTO.getFirstBase() }</span>
						<span></span>
					</td>
				</tr>
				<tr>
					...
					<td>
						<span id="secondBase">${teamDTO.getSecondBase() }</span>
						<span></span>
					</td>
				</tr>
				<tr>
					...
					<td>
						<span id="thirdBase">${teamDTO.getThirdBase() }</span>
						<span></span>
					</td>
				</tr>
				<tr>
					...
					<td>
						<span id="catcher">${teamDTO.getCatcher() }</span>
						<span></span>
					</td>
				</tr>
				<tr>
					...
					<td>
						<span id="pitcher">${teamDTO.getPitcher() }</span>
						<span></span>
					</td>
				</tr>
				<tr>
					...
					<td>
						<span id="leftFielder">${teamDTO.getLeftFielder() }</span>
						<span></span>
					</td>
				</tr>
				<tr>
					...
					<td>
						<span id="rightFielder">${teamDTO.getRightFielder() }</span>
						<span></span>
					</td>
				</tr>
				<tr>
					...
					<td>
						<span id="centerFielder">${teamDTO.getCenterFielder() }</span>
						<span></span>
					</td>
				</tr>
				<tr>
					...
					<td>
						<span id="shortStop">${teamDTO.getShortStop() }</span>
						<span></span>
					</td>
				</tr>
			</table>
